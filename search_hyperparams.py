...
def experiment():
    ...
    if args.id == 1:
        ...
        start_id = 202
        session_name = f'{start_id}'  # tmux session name, need pre-create
        ...
        param_pool_dict["occupied_mode"] = [False] # exp_143 start
        # param_pool_dict['num_workers'] = [2 * n_gpus]
        # param_pool_dict['learning_rate'] = [0.1, 0.01, 0.001, 0.0001]
        # param_pool_dict['learning_rate'] = [0.001] # 0.001 is suitable
        # param_pool_dict['learning_rate'] = [0.01] # for finetune
        # param_pool_dict['learning_rate'] = [0.01, 0.001]
        # param_pool_dict['learning_rate'] = [0.0001]
        ...
        param_pool_dict['new_flip_h_ratio'] = [0] # exp_149
        # param_pool_dict['new_flip_h_ratio'] = [0, 0.5]
        param_pool_dict['shift_w_pixel'] = [1/3/1]
        # param_pool_dict['shift_h_pixel'] = [1/12*3] # 1/12/2 default
        param_pool_dict['shift_h_pixel'] = [1/12*2] # exp_143
        # param_pool_dict['shift_w_ratio'] = [0.75]
        param_pool_dict['shift_w_ratio'] = [0] # exp_143
        param_pool_dict['shift_h_ratio'] = [0.75]
        param_pool_dict['shift_h_ratio'] = [0]
        param_pool_dict['hsv_p'] = [0]
        ...
        # param_pool_dict["angle_range"] = [15, 30] # exp_143, exp_144
        # param_pool_dict["angle_range"] = [15, 45] # exp_147, exp_148
        # param_pool_dict["angle_range"] = [15] # exp_149
        param_pool_dict["rotate_p"] = [0]
        ...
        # param_pool_dict["train_data_ratio"] = [[["seoul", 1], ["tongji", 1], ["in99_0614", 1]]] # exp_145, exp_146
        # param_pool_dict["train_data_ratio"] = [[["avm", 1], ["in99_0614", 1]]] # exp_147, exp_148
        # param_pool_dict["train_data_ratio"] = [[["avm", 1]]]
        # param_pool_dict["train_data_ratio"] = [[["in99", 1]]]
        # param_pool_dict["train_data_ratio"] = [[["in99", 1]], [["in99", 1], ["public", 1]]]
        # param_pool_dict["train_data_ratio"] = [[["in99", 1], ["public", 1]]]
        param_pool_dict["train_data_ratio"] = [[["fullimg", 1]]]
        # param_pool_dict["train_data_ratio"] = [[["public", 1]]] # for finetune
        # param_pool_dict["train_data_ratio"] = [[["public", 1]],
        #                                        [["benchmark", 1]],
        #                                        [["public", 1], ["benchmark", 1]]] # 3 exps
        # param_pool_dict["train_data_ratio"] = [[["benchmark", 1]]]
        # param_pool_dict["train_data_ratio"] = [[["public", 1], ["benchmark", 1]]]
        # param_pool_dict["val_datdata_dira_ratio"] = [[["seoul", 0], ["tongji", 1]]]
        # param_pool_dict["val_data_ratio"] = [[["in99_0614", 1]]]
        # param_pool_dict["val_data_ratio"] = [[["benchmark", 1]]]
        param_pool_dict["val_data_ratio"] = [[["fullimg", 1]]]
        # param_pool_dict["val_data_ratio"] = [[["avm", 1]]]
        param_pool_dict["save_every_epoch"] = [False]
        # param_pool_dict["save_every_epoch"] = [True]
        # param_pool_dict["eval_freq"] = [10]
        param_pool_dict["eval_freq"] = [1]
        param_pool_dict["major_metric"] = ['Recall']
        # param_pool_dict["filter_strict_point"] = [True, False]
        param_pool_dict["filter_strict_point"] = [False]
